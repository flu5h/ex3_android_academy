...
public class DataUtils {
  ...
  public static List<NewsItem> generateNews() {
    ...
    news.add(new NewsItem(
        ...
        createDate(2018, 9, 26, 10, 34).toString(),
    ...
    news.add(new NewsItem(
        ...
        criminal.getName(),
        createDate(2018, 9, 25, 12, 45).toString(),
    ...
    news.add(new NewsItem(
        ...
        animals.getName(),
        createDate(2018, 9, 20, 14, 4).toString(),
    ...
    news.add(new NewsItem(
        ...
        criminal.getName(),
        createDate(2018, 9, 18, 4, 4).toString(),
    ...
    news.add(new NewsItem(
        ...
        criminal.getName(),
        createDate(2018, 9, 17, 12, 45).toString(),
